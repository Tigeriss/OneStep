...
def make_news
  ...
  12.times do |n|
    ...
    text = "Тут будет текст новости. Тут будет текст новости. Тут будет текст новости. Тут будет текст новости."
...
def make_styles
  ...
  12.times do |s|
    ...
    text = "Тут будет описание стиля. Тут будет описание стиля. Тут будет описание стиля. Тут будет описание стиля."
